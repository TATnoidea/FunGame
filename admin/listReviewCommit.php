...
$rows=getReviewCommitByPage($page,$pageSize);
//$rows=getAllAdmin();
if(!$rows){
    alertMes("Sorry,没有评论");
    exit;
                ...
                <table class="table" cellspacing="0" cellpadding="0">
                    ...
                    <?php $i=1; foreach($rows as $row): ?>
                        <tr>
                            ...
                            <td align="center"><input type="button" value="删除" class="btn" onclick="delReviewCommit(<?php echo $row['id']; ?>)"></td>
                        </tr>
                        <?php $i++; endforeach; ?>
...
<script type="text/javascript">
    function delReviewCommit(id){
        if(window.confirm("您是否确定需要删除")){
            window.location="doAdminAction.php?act=delReviewCommit&id="+id;
        }
    }
</script>
</html>