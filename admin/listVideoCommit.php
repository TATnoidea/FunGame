...
$rows=getVideoCommitByPage($page,$pageSize);
//$rows=getAllAdmin();
if(!$rows){
    alertMes("Sorry,没有评论");
    exit;
                ...
                <table class="table" cellspacing="0" cellpadding="0">
                    ...
                    <?php  foreach($rows as $row): ?>
                        <tr>
                            ...
                            <td align="center"><input type="button" value="删除" class="btn" onclick="delVideoCommit(<?php echo $row['id']; ?>)"></td>
                        </tr>
                        <?php  endforeach; ?>
...
<script type="text/javascript">
    ...
    function delVideoCommit(id){
        if(window.confirm("您是否确定需要删除")){
            window.location="doAdminAction.php?act=delVideoCommit&id="+id;
        }
    }
</script>
</html>