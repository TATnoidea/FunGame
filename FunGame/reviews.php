...
<div class="strategy-list comWidth">
    <?php foreach($rows as $row): ?>
        <div class="strategyItem">
            <a href="#" onclick="goReviews(<?php echo $row['id'];?>)">
                <h3 class="type">测评</h3>
                <div class="strategyInfo">
                    <h2><?php echo $row['review_tit']; ?></h2>
                    <p><?php echo $row['review_pre']; ?></p>
                </div>
                <div class="strategyImg"><img src="../admin/images/reviews/<?php echo $row['pic']; ?>" ></div>
            </a>
        </div>
    <?php endforeach; ?>
...
<script type="text/javascript">
    function goReviews(id){
        window.location="des_reviews.php?id="+id;
    }
</script>
</body>
</html>