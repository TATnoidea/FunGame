...
$sqli = "select id,u_id,v_id,commit_time,commit from videos_commit where v_id='{$id}'";
$row=fetchOne($sql);
...
<div class="des-info">
    <div class="des-tit">
        <h1><?php echo $row['tit']?></h1>
    </div>
    <div class="des-summary">
        <h5><?php echo $row['pre']?></h5>
    </div>
...
<div class="commit">
    <form id="addCommentForm" method="post" action="addVideoCommit.php?id=<?php echo $_REQUEST['id'];?>">
