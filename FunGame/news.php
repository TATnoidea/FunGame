...
<div class="strategy-list comWidth">
    ...
    <div class="strategyItem">
        <a href="#" onclick="goNews(<?php echo $row['id'];?>)">
            <h3 class="type">新闻</h3>
            <div class="strategyInfo">
                <h2><?php echo $row['news_tit']; ?></h2>
                <p><?php echo $row['news_pre']; ?></p>
            </div>
            <div class="strategyImg"><img src="../admin/images/news/<?php echo $row['pic']; ?>" ></div>
        </a>
    </div>
    <?php endforeach; ?>
