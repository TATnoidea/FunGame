...
<div class="video-list comWidth">
    <?php foreach ($rows as $row): ?>
    <div class="video-item">
        <a href="#" onclick="goVideo(<?php echo $row['id']?>)">
            <div class="video-img">
                <span class="video-icon"></span>
                <img src="../admin/images/videos/<?php echo $row['pic']?>">
            </div>
            <div class="video-info">
                <h3><?php echo $row['tit']; ?></h3>
                <p><?php echo $row['pre']; ?></p>
            </div>
        </a>
    </div>
    <?php endforeach;?>
