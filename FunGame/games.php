...
<div class="games-list comWidth">
    <?php foreach($rows as $row): ?>
    <div class="gameItem">
        <a href="#">
            <div class="game-img">
                <img src="../admin/images/games/<?php echo $row['pic']; ?>" alt="<?php echo $row['pic']; ?>">
            </div>
            <div class="gameInfo">
                <ul class="gameTable">
                    <li><div class="tt">游戏名：</div><div class="txt"><?php echo $row['game_name']; ?></div></li>
                    <li><div class="tt">评分：</div><div class="txt"><?php echo $row['game_score']; ?></div></li>
                    <li><div class="tt">平台：</div><div class="txt"><?php echo $row['game_platform']; ?></div></li>
                    <li><div class="tt">发售日期：</div><div class="txt"><?php echo $row['game_sell_time']; ?></div></li>
                    <li><div class="tt">开发商：</div><div class="txt"><?php echo $row['game_devepoler']; ?></div></li>
                    <li><div class="tt">发行商：</div><div class="txt"><?php echo $row['game_publisher']; ?></div></li>
                </ul>
            </div>
        </a>
    </div>
